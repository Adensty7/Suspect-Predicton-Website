...
$sql_query = "INSERT INTO suspect(Suspect_Name, Case_ID, Officer_ID, Profession, Contact_No, Birth_Date, Gender, Address, Image_Link, Note)
VALUES('$suspect_name', '$case_id', '$officer_id', '$profession', '$contact_number', '$birth_date', '$gender', '$address', '$image','$note')";
